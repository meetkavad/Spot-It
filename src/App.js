...
// Chat Pages :
import Chat from "./pages/ChatPages/Chat.js";

// Bell Pages :
import Notification from "./pages/BellPages/Notification.js";
    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          ></Route>
          <Route
            path="/Spot-It/v1/userin/notification"
          ...
          <Route
            ...
            element={<ProfilePage />}
          ></Route>
          <Route path="/Spot-It/v1/userin/chat" element={<Chat />}></Route>
          <Route
